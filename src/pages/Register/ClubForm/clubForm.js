...
const ClubForm = () =>{
        ...
        affiliationClub(
            {
                ...
                firstNamePresident:firstNamePresident,
                lastNamePresident:lastNamePresident,
                cinNumberPresident:cinNumberPresident,
                cinDatePresident:cinDatePresident,
                cinPlacePresident:cinPlacePresident,
                phonePresident:phonePresident,
                addressPresident:addressPresident,
                postalCodePresident:postalCodePresident,
                firstNameRuler:firstNameRuler,
                lastNameRuler:lastNameRuler,
                specialityRuler:specialityRuler,
                birthDateRuler:birthDateRuler,
                placeBirthRuler:placeBirthRuler,
                nationalityRuler:nationalityRuler,
                cinNumberRuler:cinNumberRuler,
                cinDateRuler:cinDateRuler,
                cinPlaceRuler:cinPlaceRuler,
                levelStudyRuler:levelStudyRuler,
                professionRuler:professionRuler,
                addressRuler:addressRuler,
                postalCodeRuler:postalCodeRuler,
                phoneRuler:phoneRuler,
    ...
    const handleSelectGov = (event) => {
        ...
        let data = governorateList.find((o) => o?.id + "" === event?.target?.value);
    ...
    const handleSelectDelegation = (event) => {
        let data = delegationList.find((o) => o?.id + "" === event?.target?.value);
    ...
    return(
        <form inline className="form-style-8"  onSubmit={handleSubmit}>
            ...
            <div style={{width:"100%",display:'flex',alignItems:"center",justifyContent:"center"}}>
                <input type={'submit'} className={'btn primary'} value={'Ajouter'}/>
                <input type={'button'} className={'btn primary'} value={'reset'} onClick={handleReset}/>
            </div>
