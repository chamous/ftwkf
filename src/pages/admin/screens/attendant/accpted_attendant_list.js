...
function AttendantAcceptedList() {
    ...
    const getData = ({cin,page}) => {
        AdminServices.getAttendantAdmin({type: "active", cin: cin, page: page}).then(response => {
            ...
            render: (id) => {
                ...
                return <a href={`${baseUrlDownload}${selected[0]["file"]}`} target={"_blank"}>
                    <div style={{
                        ...
                        <p style={{margin: 0, color: "white", fonSize:12}}>Télécharger CIN</p>
                    </div>
                </a>
            }
        },
...
export default AttendantAcceptedList;
