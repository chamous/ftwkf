...
function RefusedCoachAffiliationList() {
    ...
    const getData = ({cin:cin,page:page}) => {
        AdminServices.getCoachAffiliations({type: "refused",cin:cin,page:page}).then(response => {
...
export default RefusedCoachAffiliationList;
