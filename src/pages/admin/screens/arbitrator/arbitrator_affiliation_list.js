...
function ArbitratorAffiliationList() {
    ...
    const getData = ({cin:cin,page:page}) => {
        AdminServices.getArbitratorAffiliations({type: "active",cin:cin,page:page}).then(response => {
...
export default ArbitratorAffiliationList;
